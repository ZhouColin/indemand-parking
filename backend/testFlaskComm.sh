...
/usr/bin/curl 'http://localhost:8080/signup?username=abc&password=123'
echo
/usr/bin/curl 'http://localhost:8080/signup?username=abcd&password=123'
echo
/usr/bin/curl 'http://localhost:8080/signup?username=abcde&password=123'
echo
...
# View Parking Spots
/usr/bin/curl 'http://localhost:8080/view?lon=3&lat=2.5&start=55&end=75&radius=5&sortMethod=closest'
echo
/usr/bin/curl 'http://localhost:8080/view?lon=3&lat=2.5&start=40&end=100&radius=5&sortMethod=closest'
echo
/usr/bin/curl 'http://localhost:8080/ml'
